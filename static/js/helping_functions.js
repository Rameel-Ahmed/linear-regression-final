...
export function showSuccessToast(message, cleanedRows) {
    ...
    toast.querySelector('.toast-content').textContent = `${cleanedRows} rows ready for training`;
...
export function showErrorToast(message) {
    ...
    toast.querySelector('.toast-content').textContent = message.includes(',') ? message.split(',').map(m => m.trim()).join('\n') : message;
