...
function updateDataSummary() {
    try {
        ...
        if (rowsRemovedElement && trainingData.cleaning_summary?.samples_removed !== undefined) {
            rowsRemovedElement.textContent = trainingData.cleaning_summary.samples_removed.toLocaleString();
        }
